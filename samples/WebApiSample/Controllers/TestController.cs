...
namespace WebApiSample.Controllers
{
    ...
    public class TestController : ApiController
    {
        ...
        // GET api/test
        public IRepresentationBuilder Get()
        {
            var builder = new RepresentationBuilder(); // should use DI to inject an instance of this in.
        ...
        // GET api/test/5
        public IRepresentationBuilder Get(int id)
        {

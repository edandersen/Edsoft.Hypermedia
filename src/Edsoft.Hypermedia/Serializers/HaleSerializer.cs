...
namespace Edsoft.Hypermedia.Serializers
{
    public class HaleSerializer : HalSerializer
    {
        ...
        protected override JObject CreateLinkObjectFromTransition(HypermediaTransition transition)
        {
        ...
        private static void AddAttributesFromAttributesDictionaryToLinkObject(
            IDictionary<string, HypermediaTransitionAttribute> attributesDictionary,
            JObject linkObject,
            string scope = null)
        {
        ...
        protected override HypermediaTransition GetTransitionFromLinkObject(JToken link, string rel)
        {
        ...
        private static Dictionary<string, HypermediaTransitionAttribute> 
            GetAttributesDictionaryFromDataToken(JToken data, string matchingScope)
        {
            var result = new Dictionary<string, HypermediaTransitionAttribute>();
            ...
            foreach (var dataProperty in ((JObject) data).Properties())
            {
                ...
                var transitionAttribute = new HypermediaTransitionAttribute();
                ...
                bool parseResult;
                transitionAttribute.Constraint = new HypermediaTransitionAttributeConstraint
                {

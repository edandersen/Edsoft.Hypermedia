...
namespace Edsoft.Hypermedia.Tests.Serializers
{
    public class HalSerializerTests : TestWithFixture
    {
        ...
        {
            var representor = new HypermediaRepresentation();
        ...
        {
            var representor = GetRepresentorWithTransitions(() => new HypermediaTransition() {Rel = Fixture.Create<string>(), Uri = Fixture.Create<string>()});
        ...
        {
            var representor = GetRepresentorWithTransitions(() => new HypermediaTransition() { Rel = Fixture.Create<string>(), Title = Fixture.Create<string>() });
        ...
        {
            var representor = GetRepresentorWithTransitions(() => new HypermediaTransition() { Rel = Fixture.Create<string>(), Type = Fixture.Create<string>() });
            var result = JObject.Parse(sut.Serialize(representor));
        ...
        {
            var representor = GetRepresentorWithTransitions(() => new HypermediaTransition() { Rel = Fixture.Create<string>(), DepreciationUri = Fixture.Create<string>() });
            var result = JObject.Parse(sut.Serialize(representor));
        ...
        {
            var representor = GetRepresentorWithTransitions(() => new HypermediaTransition() { Rel = Fixture.Create<string>(), Name = Fixture.Create<string>() });
            var result = JObject.Parse(sut.Serialize(representor));
        ...
        {
            var representor = GetRepresentorWithTransitions(() => new HypermediaTransition() { Rel = Fixture.Create<string>(), ProfileUri = Fixture.Create<string>() });
            var result = JObject.Parse(sut.Serialize(representor));
        ...
        {
            var representor = GetRepresentorWithTransitions(() => new HypermediaTransition() { Rel = Fixture.Create<string>(), LanguageTag = Fixture.Create<string>() });
            var result = JObject.Parse(sut.Serialize(representor));
        ...
        {
            var representor = GetRepresentorWithTransitions(() => new HypermediaTransition() { Rel = Fixture.Create<string>(), UriIsTemplated = Fixture.Create<bool>() });
            var result = JObject.Parse(sut.Serialize(representor));
        ...
        public void Serialize_AddsMultipleLinkItemsWhenTransitionRelIsShared()
        {
            ...
            foreach (var transition in representor.Transitions)
            {
                var hypermediaTransition = transition; // copy to prevent "Access to foreach variable in closure" warning
                relArray.Should().Contain(l => l.Value<string>("href") == hypermediaTransition.Uri);
            }
        }
        ...
        public void Serialize_SetsSingleEmbeddedResource()
        {
            ...
            representor.EmbeddedResources[key] = new List<HypermediaRepresentation> { resource };
        ...
        {
            var key = Fixture.Create<string>();
            var resources = Fixture.Create<IList<HypermediaRepresentation>>();
            var representor = Fixture.Create<HypermediaRepresentation>();
            ...
            {
                var hypermediaRepresentation = resource;
                array.Should().Contain(a => a["_links"]["self"]["href"].Value<string>() == hypermediaRepresentation.SelfLink);
            }
        }
        ...
        {
            var representor = Fixture.Create<HypermediaRepresentation>();
            representor.Collection.AddMany(() => Fixture.Create<HypermediaRepresentation>(), Fixture.Create<int>() + 1);
            ...
            {
                var hypermediaRepresentation = resource;
                embeddedCollection.Should().Contain(a => a["_links"]["self"]["href"].Value<string>() == hypermediaRepresentation.SelfLink);
            }
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionsForSingleLink()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionsForMultipleLinks()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href)));
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href2)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionsIncludingTitle()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href && t.Title == title)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionsIncludingDeprecated()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href && t.DepreciationUri == depreciationUri)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionsIncludingName()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href && t.Name == name)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionsIncludingHreflangAsLanguageTag()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href && t.LanguageTag == hreflang)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionsIncludingProfileUri()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href && t.ProfileUri == profileUri)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionUriIsTemplatedForTrue()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href && t.UriIsTemplated)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionUriIsTemplatedForFalse()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href && t.UriIsTemplated == false)));
        }
        ...
        public void DeserializeToNewBuilder_SetsTransitionsIncludingTitleAndType()
        {
            ...
            builder.AssertWasCalled(b => b.AddTransition(Arg<HypermediaTransition>.Matches(t => t.Rel == rel && t.Uri == href && t.Title == title && t.Type == type)));
        }
        ...
        public void DeserializeToNewBuilder_AddsSingleEmbeddedResource()
        {
            ...
            builder.AssertWasCalled(b => b.AddEmbeddedResource(Arg<string>.Is.Equal(key), Arg<HypermediaRepresentation>.Is.Anything), options => options.Repeat.Once());
        ...
        public void DeserializeToNewBuilder_AddsMultipleEmbeddedResources()
        {
            ...
            builder.AssertWasCalled(b => b.AddEmbeddedResource(Arg<string>.Is.Equal(key), Arg<HypermediaRepresentation>.Is.Anything), options => options.Repeat.Twice());
        ...
        public void DeserializeToNewBuilder_AddsCollectionForEmbeddedItemsKeyWithMultipleItems()
        {
            ...
            var calledCollection = (IEnumerable<HypermediaRepresentation>)builder.GetArgumentsForCallsMadeOn(b => b.SetCollection(null)).First()[0];
